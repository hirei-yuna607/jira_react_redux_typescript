...
const App: React.FC = () => {
  ...
  const handlerEditPicture = () => {
    ...
    // Avatar画像をクリックすることで、HTMLのファイルダイアログが開く
    fileInput?.click();
  };
            ...
            <div className={styles.app__logout}>
              ...
              <button className={styles.app__btn} onClick={handlerEditPicture}>
                <Avatar
                  ...
                  alt="avatar"
                  // srcがstring型かundefined型しか受け付けない
                  // loginProfileが存在する場合、image属性を見に行って、それがnullじゃない場合、そのままimageのデータをsrcに渡す。nullだったら、nullをundefinedに変換してからsrcに割り当てる
                  src={
